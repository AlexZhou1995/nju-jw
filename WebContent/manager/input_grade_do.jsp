...
<%
	...
	try {
		...
		pstmt3 = conn.prepareStatement("select sno from sc where cno=?;");
		pstmt3.setString(1,request.getParameter("cno"));
		...
		pstmt = conn.prepareStatement("select sno, name, dno, grade from (sc join student on(sc.sno = student.sno)) where cno=? and semester=? order by dno, sno;");
