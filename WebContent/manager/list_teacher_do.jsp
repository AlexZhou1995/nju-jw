    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">查看教师信息</h1>
...
<%
	...
	try {
		...
		pstmt = conn.prepareStatement("select tno, name, sex, birthday from teacher where dno=?;");
		pstmt.setString(1,  request.getParameter("dno"));
		rs = pstmt.executeQuery();
		
		pstmt2 = conn.prepareStatement("select dname from department where dno=?;");
		pstmt2.setString(1, request.getParameter("dno"));
