...
try {
	...
	pstmt2 = conn.prepareStatement("select tno from tc where cno=? and semester=?;");
...
try {
		pstmt = conn.prepareStatement("select sc.sno as sno, name, dno, grade, semester, score, tno from (sc join student on (sc.sno = student.sno)) where cno=? and semester=? order by score,sno;");
